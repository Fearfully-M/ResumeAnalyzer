    ...
    # calculate the resume keywords
        ...
        if not matched_keywords:
            ...
            matched_keywords = "The matched keywords are: " + keywords + \
                "\nThe keyword percentage match is: " + \
                str(keyword_percentage) + "%" + '\n'
...
file_button = ctk.CTkButton(
    root, text="Select a File", command=select_file, hover_color="red")
...
dropdown = ctk.CTkOptionMenu(root, variable=selected_option, values=resume_choices,
                             command=lambda choice: select_resume(choice, resume_textbox))
