...
if match_keywordsTuple[1] > 70:
    print(f"Your resume has a very high percentage of keywords (Keyword to word ratio: {match_keywordsTuple[1]}%). This might suggest keyword stuffing and could be losing context.")
    ...
    print(f"Your resume has a relatively low number of keywords used compared to the job description. (Keyword to word ratio: {match_keywordsTuple[1]}%)")
    print("Make sure you are marketing your skills effectively. For example instead of saying: ")
    print("'Responsible for developing backend solutions' you might want to rephrase it as 'Developed backend soltuions using Python and Flask to optimize performance'")
    print("The former has fewer keywords and encapsulates the details of what was done whereas the later succintly describes but includes the actual tools used and what the tools used accomplished whilst leaving the reader wanting to know more.")

elif match_keywordsTuple[1] >= 50 or match_keywordsTuple[1] <= 70:
    print("The ratio of words to keywords used in your resume compared to the job description is excellent.")
    print(f"Keyword to word ratio: {match_keywordsTuple[1]}%")
